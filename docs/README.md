...
| 改 Editor V2 | [`contracts/editor-v2.md`](contracts/editor-v2.md) | [`../src/renderer/src/components/SmartEdit/VideoEditorWorkspace/AGENTS.md`](../src/renderer/src/components/SmartEdit/VideoEditorWorkspace/AGENTS.md) |
| 改 Agent 编辑能力 | [`contracts/editor-v2.md`](contracts/editor-v2.md) | [`contracts/electron-ipc.md`](contracts/electron-ipc.md)、`src/shared/agent/` |
...
- [`architecture/current.md`](architecture/current.md)：当前 Electron、Renderer、工作区和编辑器分层。
- [`contracts/electron-ipc.md`](contracts/electron-ipc.md)：当前 `window.api`、IPC 通道和安全边界。
- [`contracts/editor-v2.md`](contracts/editor-v2.md)：Editor V2 的状态所有权、Service、Command、Playback 和媒体契约。
