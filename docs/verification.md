...
- `npm run build`：退出码 `0`；Main、Preload 和 Renderer 产物生成成功。Vite 本次转换 Main 32 个模块、Preload 1 个模块、Renderer 1876 个模块；输出 Main `154.25 kB`、Preload `5.03 kB`、Renderer JS `900.79 kB`、Renderer CSS `130.42 kB`。
